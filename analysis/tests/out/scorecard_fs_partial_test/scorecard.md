...
- base (stage 0): `/Users/alexandermueller/Research/cl-hallucination-vlm/fullstudy/results_fs/llava15_base` (EVAL_DONE)
- suite: ucit (6 stages; orders from inline (ucit_prep.py ORDER_CANONICAL; o3 = Random(41).shuffle))
- length budget k=60 words; paired bootstrap B=200, seed=17; CHAIR helpers: analysis/diag/length_controlled_chair.py
